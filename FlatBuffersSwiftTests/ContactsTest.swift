...
class ContactsTest: XCTestCase {
    ...
    func testToDataDirectRead() {
        ...
        let mailto = (i1.addressEntries[0]?.address as? EmailAddress_Direct<FlatBuffersMemoryReader>)?.mailto?§
        XCTAssertEqual(mailto, "bla@bla.io")
        
        XCTAssertEqual(i1.addressEntries[1]?.order, 1)
        XCTAssertEqual((i1.addressEntries[1]?.address as? PostalAddress_Direct<FlatBuffersMemoryReader>)?.country?§, "DE")
        XCTAssertEqual((i1.addressEntries[1]?.address as? PostalAddress_Direct<FlatBuffersMemoryReader>)?.city?§, "Berlin")
        XCTAssertEqual((i1.addressEntries[1]?.address as? PostalAddress_Direct<FlatBuffersMemoryReader>)?.postalCode, 13000)
        XCTAssertEqual((i1.addressEntries[1]?.address as? PostalAddress_Direct<FlatBuffersMemoryReader>)?.streetAndNumber?§, "Balstr, 23")
        
        XCTAssertEqual(i1.addressEntries[2]?.order, 2)
        XCTAssertEqual((i1.addressEntries[2]?.address as? WebAddress_Direct<FlatBuffersMemoryReader>)?.url?§, "http://slkf.com")
        
        XCTAssertEqual(i1.addressEntries[3]?.order, 3)
        XCTAssertEqual((i1.addressEntries[3]?.address as? TelephoneNumber_Direct<FlatBuffersMemoryReader>)?.number?§, "+4923452425")
    ...
    func testToFileDirectRead() {
        ...
        XCTAssertEqual(i1.addressEntries[0]?.order, 0)
        let mailto = (i1.addressEntries[0]?.address as? EmailAddress_Direct<FlatBuffersFileReader>)?.mailto?§
        XCTAssertEqual(mailto, "bla@bla.io")
        
        XCTAssertEqual(i1.addressEntries[1]?.order, 1)
        XCTAssertEqual((i1.addressEntries[1]?.address as? PostalAddress_Direct<FlatBuffersFileReader>)?.country?§, "DE")
        XCTAssertEqual((i1.addressEntries[1]?.address as? PostalAddress_Direct<FlatBuffersFileReader>)?.city?§, "Berlin")
        XCTAssertEqual((i1.addressEntries[1]?.address as? PostalAddress_Direct<FlatBuffersFileReader>)?.postalCode, 13000)
        XCTAssertEqual((i1.addressEntries[1]?.address as? PostalAddress_Direct<FlatBuffersFileReader>)?.streetAndNumber?§, "Balstr, 23")
        
        XCTAssertEqual(i1.addressEntries[2]?.order, 2)
        XCTAssertEqual((i1.addressEntries[2]?.address as? WebAddress_Direct<FlatBuffersFileReader>)?.url?§, "http://slkf.com")
        
        XCTAssertEqual(i1.addressEntries[3]?.order, 3)
        XCTAssertEqual((i1.addressEntries[3]?.address as? TelephoneNumber_Direct<FlatBuffersFileReader>)?.number?§, "+4923452425")
